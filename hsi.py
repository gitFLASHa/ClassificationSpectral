...
class Root(tkinter.Tk):
    ...
    def button2(self):
        self.button2 = ttk.Button(self.labelFrame2, text="Show HSI", command=self.fun1)
    ...
    def fun1(self):
        ...
        def normalize(data):
            ...
            return ((data - array_min) / (array_max - array_min)+0.1)
            # return new_array
        ...
        # Create True Color Composition
        rgb = numpy.dstack((redn, greenn, bluen))
        # Create False Color Composition
        ...
        axarr[0].imshow(rgb)
        c.save('C:/Users/Admin/Desktop/5th_channel.png')
        axarr[0].set_title('Ture color')
        axarr[1].imshow(nrg)
        axarr[1].set_title('false color')
        axarr[2].imshow(c)
